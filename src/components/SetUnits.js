...
import { OPENWEATHER_CELCIUS_VALUE, OPENWEATHER_FAHRENHEIT_VALUE } from '../common/constants';

const SetUnit = forwardRef((props, ref) => {
  return (
    <form className="bg-white p-1 bg-slate-200">
          <h2 className="font-bold">Units</h2>
          <select className="h-12 w-full caret-pink-500" ref={ref} onChange={ props.getWeather }>
