import React, { PureComponent, createRef, Suspense } from 'react';
...
export default class Weather extends PureComponent {
  ...
  loadWeather = async () => {
    try {
      ...
      }&units=imperial&appid=333458e05b25c5e69a7c22d64b7bc47f`;
  ...
  render() {
    const {
      weatherList, selectedCity, options, value,
    } = this.state;
    return (
          ...
          <form className="location-search" onSubmit={this.checkWeather}>
            ...
            <div className="location-btn">
              <Suspense fallback={<h1>Loading...</h1>}>
                <div className="order-2 flex-grow  px-5 py-5 bg-white">
