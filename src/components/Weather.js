      ...
      <div className="weather">
        ...
        <div className="location-search">
          ...
          <div className="btn-city">
            <button onClick={this.getWeather}><br/>Weather</button>
          </div>
        </div>
        ...
        <div className="location-details">
          ...
          <div className="location-temp">
            <p>CURRENT TEMPERATURE<br/>{this.state.current_temp}{' '}</p>
            <p>MINIMUM TEMPERATURE<br/>{this.state.minimum_temp}{' '}</p>
            <p>MAXIMUM TEMPERATURE<br/>{this.state.maximum_temp}{' '}</p>
          </div>
          <div className="location-wind">
            <p>Wind Speed<br/>{this.state.wind_speed}</p>
            <p>Wind Direction<br/>{this.state.wind_direction}{' '}</p>
          </div>
          <div className="location-pres">
            <p>Pressure<br />{this.state.pressure}{' '}</p>
